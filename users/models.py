...
class Transaction(models.Model):
    ...
    url_to_pay = models.TextField(verbose_name='Ссылка на оплату',
                                  default='')  # от страйпа получаю слишком длинную строку(>200), модель не принимает
